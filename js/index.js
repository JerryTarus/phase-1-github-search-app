...
form.addEventListener('submit',(e)=>{
    ...
    .then(data=> data.forEach(user=>{
      ...
      link.href = `link to their  profile`
           ...
           //Adding an event to the users to show more info about them
           h5.addEventListener('click',(e)=>{
            let username=e.target.value //This part gets the username
    
            //This section makes  a fetch request with the returned value then
            //displays the returned results on the DOM
